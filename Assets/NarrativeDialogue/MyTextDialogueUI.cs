...
public class MyTextDialogueUI : MonoBehaviour, IDialogueUI
{
    ...
    {
        bubble.enabled = true;
        bubble.transform.position = subtitle.speakerInfo.transform.position;
        bubble.transform.Translate(Vector3.up * 7);
        bubble.transform.Translate(Vector3.right * 7);
        bubble.SetSpeechBubble(subtitle);
